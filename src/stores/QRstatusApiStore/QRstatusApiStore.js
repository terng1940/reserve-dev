import { fetchQRstatusService } from 'api/products';
import { makeAutoObservable } from 'mobx';

export class QRstatusApiStore {
    isLoading = false;
    isError = false;
    statusCode = null;
    ...
    async handleQRstatusService(body) {
        try {
            this.updateIsError(false);
            this.updateStatusCode(null);
            this.updateIsLoading(true);

            const result = await fetchQRstatusService(body);
