import { fetchInformationService } from 'api/products';
import { makeAutoObservable } from 'mobx';

export class InformationApiStore {
    isLoading = false;
    isError = false;
    statusCode = null;
    ...
    async handleInformationService() {
        try {
            this.updateIsError(false);
            this.updateStatusCode(null);
            this.updateIsLoading(true);

            const result = await fetchInformationService();
