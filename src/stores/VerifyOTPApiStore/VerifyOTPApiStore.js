import { fetchVerifyOTPService } from 'api/products';
import { makeAutoObservable } from 'mobx';

export class VerifyOTPApiStore {
    isLoading = false;
    isError = false;
    statusCode = null;
    ...
    async handleVerifyOTPService(body) {
        try {
            this.updateIsError(false);
            this.updateStatusCode(null);
            this.updateIsLoading(true);

            const result = await fetchVerifyOTPService(body);
