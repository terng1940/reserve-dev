import { fetchPostReserveService } from 'api/products';
import { makeAutoObservable } from 'mobx';

export class PostReserveApiStore {
    isLoading = false;
    isError = false;
    statusCode = null;
    ...
    async handlePostReserveService(body) {
        try {
            this.updateIsError(false);
            this.updateStatusCode(null);
            this.updateIsLoading(true);

            const result = await fetchPostReserveService(body);
